...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus('error');
      setErrorMessage(error?.message || 'Network error. Please check your connection or email us at hello@orbact.com.');
    }
  };
                  ...
                  {status === 'success' ? (
                    <div className="flex flex-col items-center justify-center text-center h-full min-h-[500px]">
                      ...
                      <p className="text-muted text-lg mb-10 animate-fade-in-up max-w-xs mx-auto leading-relaxed" style={{ animationDelay: '0.2s' }}>
                        We've sent a confirmation to <span className="text-text-main font-semibold">{submittedEmail}</span>. Our architects will decode your request shortly.
                      </p>
