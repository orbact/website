        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="animate-fade-in-up max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[1.1] text-text-main mb-6">
              We Build <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-text-main via-accent-primary to-accent-secondary animate-shine bg-[length:200%_auto]">AI That Ships.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 mb-8">
              <Button onClick={() => navigate('/contact')} icon className="shadow-lg shadow-accent-primary/20 w-full sm:w-auto">Start Building</Button>
              <Button variant="outline" onClick={() => navigate('/solutions')} className="w-full sm:w-auto">Our Services</Button>
            </div>
